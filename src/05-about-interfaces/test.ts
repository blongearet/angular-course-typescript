...
describe('about interfaces', () => {
  ...
  it('5-can have readonly properties', () => {
    ...
    try {
      // _ : Cannot compile with the line below!
    ...
    */
    ...
    try {
      const propertyNameHacked = 'first' + 'Name';
      person[propertyNameHacked] = 'Jane';
    } catch (e) {
      error = true;
    }

    // We don't throw error as typings in only on build side
    //  not on the running side
  ...
  it('7-readonly maps', () => {
    ...
    */
    ...
    try {
      ...
      //  not on the running side
      const propertyNameHacked = 'first' + 'Name';
      contacts['johnId'][propertyNameHacked] = 'Jane';
    }
    catch (e) {
      error = true;
    }
